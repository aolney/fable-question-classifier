...
const features = (0, _List.ofArray)([new Feature("WHAT", "\\b[Ww]hat/[A-Z]+", true), new Feature("HOW", "\\b[Hh]ow/[A-Z]+", true), new Feature("WHO_", "\\b([Ww]ho|[Ww]hose|[Ww]hom)/[A-Z]+", true), new Feature("WHERE", "\\b[Ww]here/[A-Z]+", true), new Feature("WHEN", "\\b[Ww]hen/[A-Z]+", true), new Feature("WHICH", "\\b[Ww]hich/[A-Z]+", true), new Feature("WHY", "\\b[Ww]hy/[A-Z]+", true), new Feature("WOULD", "\\b[Ww]ould/[A-Z]+", true), new Feature("A", "\\b[Aa]n?/[A-Z]+", true), new Feature("NEG", "\\b([Nn]ever|[Nn]ot|[Nn]or|[Nn]either|n't|'t|t)/[A-Z]+", true), new Feature("YOU", "\\b[Yy]ou/[A-Z]+", true), new Feature("YOUR", "\\b[Yy]our/[A-Z]+", true), new Feature("SHOULD", "\\b[Ss]hould/[A-Z]+", true), new Feature("TELL", "\\b[Tt]ell/[A-Z]+", true), new Feature("@FROM", "\\b[Ff]rom/[A-Z]+", true), new Feature("BETWEEN", "\\b[Bb]etween/[A-Z]+", true), new Feature("@AND", "\\b[Aa]nd/[A-Z]+", true), new Feature("HAPPENCONS HAPPENANTE HAPPENEXPE", "\\b[Hh]appen(s|ed)?/[A-Z]+", true), new Feature("#DISJUNCTION", "\\b[Oo]r/[A-Z]+", true), new Feature("#DEFINITION", "\\b([Dd]efinition|[Mm]eaning|[Dd]efine)/[A-Z]+", true), new Feature("#EXAMPLE", "\\b(example|type|kind|claim|evidence|illustration|instance|support|evidence|prototype|standard|exemplar|picture|case|demonstration|[Ss]how|[Dd]emonstrate|[Ee]xemplify|[Ii]llustrate|[Qq]ualify|typical|model|standard|exemplar)/[A-Z]+", true), new Feature("#QUANTIFICATION", "\\b(amount|number|sum|distance|measurement|length|width|size|height|average|total|approximation)/[A-Z]+", true), new Feature("#FEATURESPEC", "\\b(characteristics?|colors?|parts?|features?|sounds?|propert(y|ies)|attributes?|shapes?|smell(s|ed)?|taste(s|d)?|look(s|ed)?|feels?|felt|sound(s|ed)?|dimension|[Ss]pecify|[Ll]ist|[Dd]escribe|[Cc]haracterize)/[A-Z]+", true), new Feature("#ENABLEMENT", "\\b(tools|useful|helpful|indicated|helps?|need(ed)?|required?|helped|allows?|necessary|have/[A-Z]+ to|in/[A-Z]+ order/[A-Z]+ to)/[A-Z]+", true), new Feature("#CAUSALCONS", "\\b(outcomes?|results?|consequences?|effects?|originates?/[A-Z]+ (in|from)|a?rises?/[A-Z]+ from|springs?/[A-Z]+ from|emanates?/[A-Z]+ from|comes?/[A-Z]+ from|issues?/[A-Z]+ from|flows?/[A-Z]+ from|results?/[A-Z]+ from|depends?/[A-Z]+ (upon|on)|hangs?/[A-Z]+ (upon|on)|hinges?/[A-Z]+ (upon|on)|turns?/[A-Z]+ (upon|on)|conclusion/[A-Z]+ of)/[A-Z]+|HAPPENCONS", true), new Feature("#COMPARISON", "\\b(differences?|similarity?(ies)?|[Dd]istinguish(ed|es)?|[Ss]eparate(d|s)?|[Vv]ar(y|eed|ies)?|[Dd]iscriminate(d|s)?|[Cc]ontrast(ed|s)?|[Dd]iffer(ed|s)?|same|different|similar|like|less|[Rr]elate(d|s)?|[Cc]ompare(d|s)?)/[A-Z]+|[a-z]+/JJR|TELL[^@]*@FROM|BETWEEN[^@]*@AND", true), new Feature("#INSTRUMENTAL", "\\b(plan|scheme|design|proposal|suggestion|arrangement|outline|program|method|way|manner|form|mode|procedure|route|steps|process|used?)/[A-Z]+", true), new Feature("#CAUSALANTE", "\\b(reason|causes?d?|allows?(ed)?|led|lead(s)?|stems?(ed)?|occurs?(ed)?|transpires?(ed)?|made|because|unless)/[A-Z]+|HAPPENANTE", true), new Feature("#GOALORIENTATION", "\\b(motivation|motives?|reasons?|grounds|principles?|intentions?|consideration|attraction|temptation|charm|pull|incentive|stimulus|aim|ends?|destination|goals?|target|fascination|induces?d?|possess(ed)?(es)?|move[sd]|inspires?d?|prompts|purposes?|seeks?|plans?|contemplate|desire|pursue|aims?|aspire|stimulates?d?|thinking|rouses|incites?d?|provokes?d?|instigates?d?|encourages?d?|tempts?(ed)?|fascinates?d?|lures?d?)/[A-Z]+", true), new Feature("#JUDGMENTAL", "\\b(SHOULD|(thoughts?|judgments?|decisions?|findings?|opinions?|assessments?|beliefs?|views?|impressions?|conceptions?|conclusions?|decide|decisions?|findings?|find|conceive|realizations?|realize|rate|understanding?|recommend|impressions?|understand|recognize|think|consider|believe|advise|conclude|indicate)/[A-Z]+)", true), new Feature("#INTERPRETATION", "\\b(meaning|significance|sense|essence|spirit|suggestions?|interpretations?|explanations?|diagnosis|solution|answer|rendition|translation|commentary|inference|deduction|imply|[Ll]ink|[Cc]omment|[Ee]xplain(ed)?|[Mm]eans?|[Ii]nterpret|[Gg]uess|signify|denote|[Ee]xpress|convey|[Ii]ndicate|declare|involve|affirm|[Ss]tate|construed?|translate|infer(red)?|render|[Ss]olve|disentangled?|unravel(ed)?|[Cc]haracterized?|[Cc]larify?(ied)?|[Ee]xplain(ed)?|tells?/[A-Z]+ of|speaks?/[A-Z]+ of|points?/[A-Z]+ to|alludes?/[A-Z]+ to|drives?/[A-Z]+ at|makes?/[A-Z]+ out|accounts?/[A-Z]+ for|comments?/[A-Z]+ upon)/[A-Z]+", true), new Feature("#EXPECTATIONAL", "\\bHAPPENEXPE", true), new Feature("DO", "\\b([Dd]o|[Dd]oes|[Dd]id|[Dd]oing|[Dd]one)n?/[A-Z]+", true), new Feature("HAVE", "\\b([Hh]ave|[Hh]as|[Hh]ad|[Hh]aving|'ve|'d)n?/[A-Z]+", true), new Feature("BE", "\\b([Aa]m|[Ii]s|[Aa]re|[Ww]as|[Ww]ere|[Bb]eing|[Bb]een|'m|'re|'s)n?/[A-Z]+", true), new Feature("MODAL", "\\b([Cc]an|[Mm]ay|[Ss]hall|[Ww]ill|'ll|[Cc]ould|[Mm]ight|[Ss]hould|[Ww]ould|[Mm]ust)n?/[A-Z]+|\\b[Ww]on/[A-Z]+", true), new Feature("SUBJPRO", "\\b([Ii]|[Hh]e|[Ww]e|[Ss]he|[Tt]hey)/[A-Z]+", true), new Feature("OBJPRO", "\\b([Mm]e|[Uu]s|[Hh]im|[Tt]hem)/[A-Z]+", true), new Feature("PRO", "\\b([Yy]ou|[Hh]er|[Ii]t)/[A-Z\\$]+", true), new Feature("PREP", "\\b([Aa]gainst|[Aa]mid|[Aa]midst|[Aa]mong|[Aa]t|[Bb]esides|[Bb]etween|Bb]y|[Dd]espite|[Dd]uring|[Ee]xcept|[Ff]or|[Ff]rom|[Ii]n|[Ii]nto|[Mm]inus|[Nn]otwithstanding|[Oo]f|[Oo]ff|[Oo]n|[Oo]nto|[Oo]pposite|[Oo]ut|[Pp]er|[Pp]lus|[Pp]ro|[Rr]e|[Tt]han|[Tt]hrough|[Tt]hroughout|[Tt]hru|[Tt]o|[Tt]oward|[Tt]owards|[Uu]pon|[Vv]ersus|[Vv]ia|[Ww]ith|[Ww]ithin|[Ww]ithout)/IN", true), new Feature("WHO", "\\b([Ww]hat|[Ww]here|[Ww]hen|[Hh]ow|[Ww]hether|[Ww]hy|[Ww]hoever|[Ww]homever|[Ww]hichever|[Ww]herever|[Ww]henever|[Ww]hatever|[Hh]owever)/[A-Z\\$]+", true), new Feature("WHP", "\\b([Ww]ho|[Ww]hom|[Ww]hose|[Ww]hich)/[A-Z\\$]+", true), new Feature("ART", "\\b([Aa]|[Aa]n|[Tt]he)/[A-Z]+", true), new Feature("QUAN", "\\b([Ee]ach|[Aa]ll|[Ee]very|[Aa]ny|[Mm]any|[Mm]uch|[Ff]ew|[Ss]everal|[Ss]ome)/[A-Z]+", true), new Feature("ADV", "\\b[A-Za-z]+/RB[RS]?", true), new Feature("ADJ", "\\b[A-Za-z]+/JJ[RS]?", true), new Feature("VBN", "\\b[A-Za-z]+/(VBD|VBN)", true), new Feature("VBG", "\\b[A-Za-z]+/VBG", true), new Feature("VBZ", "\\b[A-Za-z]+/VBZ", true), new Feature("VB", "\\b[A-Za-z]+/VB", true), new Feature("NNS", "\\b[A-Za-z]+/NNS", true), new Feature("NNP", "\\b[A-Za-z]+/(NNP|NNPS)", true), new Feature("NN", "\\b[A-Za-z]+/NN", true), new Feature("NN", "\\b[A-Za-z]+/N", true), new Feature("QUOTE", "'/\"", true), new Feature("#CAUSALCONS", "\\b(BE ART effects?/[A-Z]+ of|BE due/[A-Z]+ to)/[A-Z]+", true), new Feature("#DEFINITION", "\\bTELL OBJPRO WHAT", true), new Feature("VERIFICATION", "^[ ]?(MODAL|WOULD|SHOULD|DO|HAVE|BE)", false), new Feature("CONCEPTCOMPLETION", "^[ ]?(WHAT|WHO_|WHERE|WHEN|WHICH)", false), new Feature("DEFINITION", "^[ ]?WHAT (MODAL|WOULD|SHOULD|DO|HAVE|BE)([^#]*#?[^#]*#DEFINITION|[ ]?(A )?(ADJ |ADV )*(NN[SP]?[S]?|[^/]+/NNP))|^(MODAL|WOULD) YOU[^#]*#?[^#]*#DEFINITION|WHAT (A )?(ADJ |ADV )*(NN[SP]?[S]?|[^/]+/NNP) BE", false), new Feature("DISJUNCTION", "^[ ]?(MODAL|WHICH|WOULD|SHOULD|DO|HAVE|BE)[^#]*#?[^#]*#DISJUNCTION", false), new Feature("EXAMPLE", "^[ ]?(WHAT (MODAL|WOULD|SHOULD|DO|HAVE|BE)?| (MODAL|WOULD|SHOULD|DO|HAVE|BE))[^#]*#?[^#]*#EXAMPLE", false), new Feature("QUANTIFICATION", "^[ ]?WHAT (MODAL|WOULD|SHOULD|DO|HAVE|BE)?[^#]*#?[^#]*#QUANTIFICATION|(^[ ]?|[ ]?ALL-P|PREP)[ ]?HOW (QUAN|ADJ|ADV)|^ (WOULD|MODAL) YOU[^#]*#?[^#]*#QUANTIFICATION", false), new Feature("FEATURESPEC", "^[ ]?WHAT[^#]*#?[^#]*#FEATURESPEC|#FEATURESPEC", false), new Feature("ENABLEMENT", "^[ ]?(WHO|WHAT|HOW|WHO_|WHERE|WHEN|WHY)[^#]*#?[^#]*#ENABLEMENT", false), new Feature("JUDGMENTAL", "\\b(YOU|YOUR) #JUDGMENTAL|(SHOULD|#JUDGMENTAL) (SUBJPRO|PRO|NN[SP]?[S]?)|^[ ]?(WHAT|HOW|WHY) SHOULD", false), new Feature("CAUSALCONS", "^[ ]?(WHAT| DO)[^#]*#?[^#]*#CAUSALCONS", false), new Feature("COMPARISON", "(^[ ]?WHAT|^[ ]?(WHP|WHICH)) (BE|MODAL|WOULD|SHOULD)?[^#]*#?[^#]*#COMPARISON|HOW[^#]*#?[^#]*#COMPARISON|^ (MODAL|WOULD) YOU[^#]*#?[^#]*#COMPARISON", false), new Feature("CAUSALANTE", "^[ ]?(WHY|HOW) (DO|BE|MODAL|WOULD|SHOULD)[^#]*#?[^#]*(VBD?N?G?|#CAUSALANTE)|^ (DO|MODAL|WOULD|SHOULD)[^#]*#?[^#]*#CAUSALANTE|(^|ALL-P)[ ]?(WHO|WHAT|HOW|WHO_|WHERE|WHEN|WHY)[ ]? #CAUSALANTE", false), new Feature("GOALORIENTATION", "^[ ]?WHY (DO|BE) (YOU|SUBJPRO|PRO|ART #GOALORIENTATION|(ART )?NN[SP]?[S]?)|(^[ ]?WHAT|^[ ]?(WHP|WHICH))([^#]*#?[^#]*#GOALORIENTATION|MODAL|WOULD|SHOULD PRO)|^[ ]?(WHAT|WHY) WOULD (ART |A )?(YOU|SUBJPRO|PRO|NN[SP]?[S]?)", false), new Feature("INSTRUMENTAL", "^[ ]?HOW (MODAL|WOULD|SHOULD|DO) ((ART )?NN[SP]?[S]?|YOU|SUBJPRO|PRO)|^[ ]?(WHO|WHAT|HOW|WHO_|WHERE|WHEN|WHY)[^#]*#?[^#]*#INSTRUMENTAL|^[ ]?(WHO|WHAT|HOW|WHO_|WHERE|WHEN|WHY) NN[SP]?[S]?[^#]*#?[^#]*#INSTRUMENTAL|^ (MODAL|WOULD) YOU[^#]*#?[^#]*#INSTRUMENTAL", false), new Feature("EXPECTATIONAL", "^[ ]?WHY (HAVE|BE|DO)?[^#]*#?[^#]*NEG|MODAL #CAUSALCONS #CAUSALANTE", false), new Feature("INTERPRETATION", "INTERPRETATION", false)]);
exports.features = features;

const patternInput$0040393 = (() => {
...
const patterns = patternInput$0040393[1];
exports.patterns = patterns;
const casscade = patternInput$0040393[0];
...
const questionRegex = (0, _RegExp.create)("^(PREP )?(WHO|WHO_|WHAT|HOW|WHY|WHERE|WHEN|WHP|MODAL|DO|HAVE|BE|SHOULD|#KEYS_JUDGEMENTAL|WOULD|WHICH).*");
...
function IndirectQuestionMode$reflection() {
  return (0, _Reflection.union)("QuestionClassifier.IndirectQuestionMode", [], IndirectQuestionMode, () => ["IsOn", "IsOff"]);
}
...
function ClassificationMode$reflection() {
  return (0, _Reflection.union)("QuestionClassifier.ClassificationMode", [], ClassificationMode, () => ["Monothetic", "AllFeatures", "Debug"]);
}
    ...
    case 2:
      {
        ...
        const newWeights = classification[1];
        newWeights.splice(0, 0, [patternInput[0], -1]);
        newWeights.splice(0, 0, [ForceIndirectQuestion(patternInput[0]), -1]);
        return [c, newWeights];
      }
