...
FSharpMap.prototype.GetHashCode = function () {
  ...
  while (e$$1.MoveNext()) {
    ...
    res$$3 = combineHash(res$$3, (0, _Util.structuralHash)(activePatternResult3092[0]));
    res$$3 = combineHash(res$$3, (0, _Util.structuralHash)(activePatternResult3092[1]));
  }
...
function groupBy(projection, xs, comparer$$24) {
  ...
  (0, _Seq.iterate)(function (v$$30) {
    ...
    if (dict.has(key)) {
      ...
      (0, _Util.ignore)(dict.set(key, Array.from([v$$30])));
    }
  }, xs);
...
function countBy(projection$$1, xs$$1, comparer$$25) {
  ...
  (0, _Seq.iterate)(function (value$$1) {
    ...
    (0, _Util.ignore)(dict$$1.has(key$$1) ? dict$$1.set(key$$1, dict$$1.get(key$$1) + 1) : dict$$1.set(key$$1, 1));
  }, xs$$1);
