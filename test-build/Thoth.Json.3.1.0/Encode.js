...
var _Date = require("../fable-library.2.3.8/Date");

var _TimeSpan = require("../fable-library.2.3.8/TimeSpan");

var _Long = require("../fable-library.2.3.8/Long");
...
function option(encoder) {
  return function ($arg$$1) {
    const option$$2 = (0, _Option.defaultArg)($arg$$1, null, encoder);
...
function autoEncodeRecordsAndUnions(extra, isCamelCase, t) {
  ...
  if ((0, _Reflection.isRecord)(t, true)) {
    ...
    }((clo1 = (0, _String.toText)((0, _String.printf)("Cannot generate auto encoder for %s. Please pass an extra encoder.")), function (arg10) {
      return clo1(arg10);
    })((0, _Reflection.fullName)(t)));
  }
}

function autoEncoder(extra$$1, isCamelCase$$1, t$$1) {
  const fullname = (0, _Reflection.fullName)(t$$1);
  const matchValue$$1 = (0, _Map.tryFind)(fullname, extra$$1);
    ...
    if ((0, _Reflection.isArray)(t$$1)) {
      ...
      if ((0, _Reflection.isTuple)(t$$1)) {
        ...
        return function (value$$23) {
          var source$$4;
          return seq((source$$4 = (0, _Reflection.getTupleFields)(value$$23), (0, _Seq.mapIndexed)(function mapping$$2(i$$1, x) {
        ...
        if (fullname$$1 === "Microsoft.FSharp.Core.FSharpOption`1[System.Object]") {
          ...
          return function d$$2(value$$24) {
            if (value$$24 == null) {
              return nil;
            } else {
              return encoder$$4.Value(value$$24);
            }
          };
          ...
          if ((0, _Reflection.fullName)(keyType) === "System.String" ? true : (0, _Reflection.fullName)(keyType) === "System.Guid") {
            return function (value$$26) {
              ...
              return (0, _Seq.fold)(function folder$$1(target$$3, _arg1$$1) {
                const activePatternResult5961 = _arg1$$1;
                target$$3[activePatternResult5961[0]] = valueEncoder(activePatternResult5961[1]);
                return target$$3;
              }, state$$1, value$$26);
            };
          } else {
            ...
            return function (value$$27) {
              return seq((0, _Seq.map)(function mapping$$3(_arg2) {
                const activePatternResult5965 = _arg2;
                return [keyEncoder(activePatternResult5965[0]), valueEncoder(activePatternResult5965[1])];
              }, value$$27));
            };
          }
        } else {
      ...
      return function d$$3(value$$28) {
        return value$$28;
      };
    } else if (fullname === "System.String") {
      return function d$$4(value$$30) {
        return value$$30;
      };
    } else if (fullname === "System.Int32") {
      return function d$$5(value$$32) {
        return value$$32;
      };
    } else if (fullname === "System.UInt32") {
      return function d$$6(value$$34) {
        return value$$34;
      };
    } else if (fullname === "System.Double") {
      return function d$$7(value$$36) {
        return value$$36;
      };
...
function Auto$$$generateEncoderCached$$4AE6C623(isCamelCase$$2, extra$$2, resolver) {
...
function Auto$$$generateEncoder$$4AE6C623(isCamelCase$$4, extra$$4, resolver$$2) {
  const isCamelCase$$5 = (0, _Option.defaultArg)(isCamelCase$$4, false);
  let extra$$5;

  if (extra$$4 == null) {
    extra$$5 = (0, _Map.empty)({
      Compare: _Util.comparePrimitives
    });
  } else {
    const e$$1 = extra$$4;
...
function Auto$$$toString$$59982D9A(space$$1, value$$42, isCamelCase$$6, extra$$6, resolver$$4) {
